...
const HoldingLiveChart = ({ selectedQuote }: { selectedQuote: string }) => {
	if (!selectedQuote) {
		return null;
	}
		...
		<Card className="pt-0">
			<CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
				<div className="grid flex-1 gap-1">
					<CardTitle>{selectedQuote} Area chart</CardTitle>
					<CardDescription>
						Showing CLOSE and OPEN price for {timeRange}
					</CardDescription>
				</div>
...
export default HoldingLiveChart;
